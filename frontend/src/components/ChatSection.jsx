...
//         // Call the voice API endpoint for voice input
//         handleVoiceApiCall(transcript);
//       };
...
//   // Function for handling text-based API call
...
//   const handleVoiceApiCall = async (text) => {
//     try {
//       const response = await fetch('http://127.0.0.1:5000/texttovoice', {
//         method: 'POST',
...
//       }
//       // Directly get the blob
//       const audioBlob = await response.blob();
//       console.log("Audio blob size:", audioBlob.size);
//       if (audioBlob.size === 0) {
//         console.error("Received an empty audio blob. Check CORS or response headers.");
//       }
//       const audioUrl = URL.createObjectURL(audioBlob);
//       setMessages(prev => [
//         ...prev.filter(msg => !msg.loading),
//         { type: 'agent-voice', audioUrl }
//       ]);
//       return audioUrl;
//     } catch (error) {
